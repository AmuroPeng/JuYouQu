...
add_shop('汉丽轩自助涮烤超市（双井店）', '朝阳区百环家园甲19号恺兴文化二楼', result7['lng'], result7['lat'], 3.0, '营业时间： 周一至周日 11:00-22:00', '美食',
         '/picture/7.jpg')

result8 = get_loc('海淀区西直门北大街32号枫蓝国际购物中心')
add_shop('韩时烤肉（枫蓝国际购物中心店）', '海淀区西直门北大街32号枫蓝国际购物中心2层', result8['lng'], result8['lat'], 4.7, '营业时间： 周一至周日 10:30-21:30',
         '美食', '/picture/8.jpg')
...
add_shop('金源福城肥牛火锅（远大路金源店）', '海淀区远大路1号金源时代购物中心五层5-17号', result11['lng'], result11['lat'], 4.2, '营业时间：周一至周日 10:00-23:00',
         '美食', '/picture/11.jpg')
...
add_shop('三清洞摩西年糕火锅（万达店）', '通州区通州北苑万达广场西门金街b区二层264号', result13['lng'], result13['lat'], 4.2, '营业时间： 周一至周日 09:30-21:30 ',
         '美食', '/picture/13.jpg')

result14 = get_loc('海淀区复兴路69号蓝色港湾购物中心')
add_shop('耀莱成龙国际影城(五棵松店)', '海淀区复兴路69号蓝色港湾购物中心北区5层', result14['lng'], result14['lat'], 4.8, '营业时间： 周一至周日 09:30-23:30',
         '电影演出', '/picture/14.jpg')

result15 = get_loc('朝阳区西大望南路与弘燕南一路交叉口铭泽生活广场')
add_shop('大地影院(十里河铭泽影院 )', '朝阳区西大望南路与弘燕南一路交叉口铭泽生活广场5层', result15['lng'], result15['lat'], 3.8, '营业时间：周一至周日 09:30-23:30',
         '电影演出', '/picture/15.jpg')
...
add_shop('BOXING熔石训练馆', ' 朝阳区青年路华纺新天地3号楼302', result19['lng'], result19['lat'], 3.5, '营业时间：周一至周日 10:00-23:00', '运动健身',
         '/picture/19.jpg')
